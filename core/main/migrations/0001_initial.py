    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('one', 'Один ответ'), ('multiple', 'Несколько ответов'), ('text', 'Развернутый ответ')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='students', to='main.classroom')),
            ],
        ),
        migrations.CreateModel(
            name='StudentAnswer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tests', to='main.classroom')),
